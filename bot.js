...
bot.on('message', message => 
{
    try
    {
        ...
        if(message.content.startsWith('cowception')||message.content.startsWith('Cowception'))
        {
		  ...
		  {
		  	comands = 'cowception 1 type cowception # text and watch the magic.\nthere is also !info and !help\nalso note that options other than help are not called useing cowception!option,/nthey can be called by just typing !option'.split( ' ');
		  }
